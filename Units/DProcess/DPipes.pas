...
// L505
procedure TInputPipeStream.DiscardLarge(Count: Int64;
  const MaxBufferSize: Longint);
var
...
// L505
procedure TInputPipeStream.FakeSeekForward(Offset: Int64;
  const Origin: TSeekOrigin; const Pos: Int64);
// var
// Buffer: Pointer;
...
begin
  raise EStreamError.CreateFmt
    ('Cannot write to this stream, not implemented', []);
end;
...
begin
  raise EStreamError.CreateFmt
    ('Cannot read from this stream, not implemented', []);
end;
...
function TOutputPipeStream.Seek(const Offset: Int64;
